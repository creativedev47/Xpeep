          ...
          for (const metadata of visibleMarkets) {
            ...
            if (market) {
              fetched.push({
                ...
                title:
                  market.description?.toString() ||
                  metadata.title ||
                  'Untitled Market',
                category: metadata.category || 'General',
                totalStaked: market.total_staked
                  ? (parseFloat(market.total_staked) / 10 ** 18).toFixed(2)
                  : '0.00',
                ...
                endTime: market.end_time
                  ...
                  : 'N/A',
                status:
                  market.status?.name || market.status?.toString() || 'Open'
              });
            }
          }
          ...
          <section className='flex flex-col lg:flex-row items-center gap-12 min-h-[70vh]'>
            <div className='flex-1 text-center lg:text-left'>
              ...
              <h1 className='text-5xl md:text-7xl font-bold mb-6 leading-tight text-primary'>
                Peep the <span className='text-primary text-glow'>Future</span>.
                <br />
              </h1>
              <p className='text-soft-blue/80 text-lg md:text-xl max-w-2xl mb-10'>
                The world's first high-stakes decentralized prediction market
                built for speed and fun. Leverage MultiversX's sub-second
                finality to peep into tomorrow.
              </p>
          ...
          <section className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='glass-panel p-8 bg-glow-primary'>
              ...
              <p className='text-soft-blue/80 text-sm'>
                Powered by MultiversX, transactions are settled in less than a
                second with near-zero fees.
              </p>
            </div>
            <div className='glass-panel p-8 bg-glow-secondary'>
              ...
              <p className='text-soft-blue/80 text-sm'>
                No middleman. All peeps and resolutions are handled by secure
                smart contracts.
              </p>
            </div>
            <div className='glass-panel p-8'>
              ...
              <p className='text-soft-blue/80 text-sm'>
                From crypto prices to pop culture, peep on anything that matters
                to the world.
              </p>
            </div>
          </section>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              {isLoading ? (
                <div className='col-span-full flex flex-col items-center py-10 gap-4'>
                  ...
                  />
                  <p className='text-soft-blue/80 font-bold uppercase tracking-widest text-xs'>
                    Loading trending peeps...
                  </p>
                </div>
